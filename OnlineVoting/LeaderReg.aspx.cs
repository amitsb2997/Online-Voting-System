...
public partial class LeaderReg : System.Web.UI.Page
{
    ...
    protected void Register(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            scmd = new SqlCommand("insert into voters values(@vid,@vtnm,@vps,'leader',default);", scon);
            ...
            scmd = new SqlCommand("insert into voter_info values(@a,@b,@c,@d,@e,@f,@g,@h,@i,@j,'leader');", scon);
