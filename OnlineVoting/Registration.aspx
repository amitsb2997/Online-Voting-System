r<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Registration.aspx.cs" Inherits="Registration" %>
...
<body bgcolor="#E6E6FA">
    ...
    <table >
        <h1 style="width: 468px">Voters Registration Form</h1>
        <hr />
                <tr>
        ...
        <tr>
            <td class="auto-style7">VoterName</td>
